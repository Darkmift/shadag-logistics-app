...
- [TS](https://nuxt.com/docs/guide/concepts/typescript#nuxttsconfigjson)
- [i18n - use](https://vue-i18n.intlify.dev/api/general#createi18n)
- [i18n - install](https://i18n.nuxtjs.org/getting-started/basic-usage)
